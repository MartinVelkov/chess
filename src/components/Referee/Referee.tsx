...
import { bishopMove, getPossibleBishopMoves, getPossibleKingMoves, getPossibleKnightMoves, getPossiblePawnMoves, getPossibleQueenMoves, getPossibleRookMoves, getPossiblePrincessMoves, getPossiblePrinceMoves, kingMove, knightMove, pawnMove, queenMove, rookMove, princeMove, princessMove } from "../../referee/rules";
